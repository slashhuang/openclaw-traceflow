...
export default {
  ...
  'systemPrompt.bootstrapHeaderTitle': 'OpenClaw 引导文件一览（Project Context 注入顺序）',
  'systemPrompt.bootstrapHeaderHint':
    '下列文件名与 OpenClaw「Workspace bootstrap injection」一致。展开面板内为职责说明、最佳实践与磁盘正文。',
  'systemPrompt.harness.tierPrimaryTitle': '核心引导（AGENTS / SOUL / IDENTITY / USER）',
  'systemPrompt.harness.tierPrimaryDesc': '默认展开：人设、用户与总指令优先可见。',
  'systemPrompt.harness.tierSecondaryTitle': '其余引导（TOOLS / HEARTBEAT / BOOTSTRAP / MEMORY）',
  'systemPrompt.harness.tierSecondaryDesc': '默认收起：工具说明、心跳、一次性引导与长期记忆。',
