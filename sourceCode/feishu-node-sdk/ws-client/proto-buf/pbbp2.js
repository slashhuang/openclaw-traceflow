...
export const pbbp2 = ($root.pbbp2 = (() => {
    ...
    pbbp2.Frame = (function () {
         ...
         * @instance
         */
        Frame.prototype.SeqID = $util.Long
         ...
         * @instance
         */
        Frame.prototype.LogID = $util.Long
            ? $util.Long.fromBits(0, 0, true)
            : 0;
        ...
        Frame.verify = function verify(message) {
            ...
            if (
                message.payloadType != null &&
                message.hasOwnProperty('payloadType')
            )
            ...
            if (message.payload != null && message.hasOwnProperty('payload'))
                if (
                    !(
                        (message.payload &&
                            typeof message.payload.length === 'number') ||
        ...
        Frame.fromObject = function fromObject(object) {
            ...
            if (object.SeqID != null)
                if ($util.Long)
                    (message.SeqID = $util.Long.fromValue(
                        object.SeqID
                    )).unsigned = true;
            ...
            if (object.LogID != null)
                if ($util.Long)
                    (message.LogID = $util.Long.fromValue(
                        object.LogID
                    )).unsigned = true;
            ...
            if (object.headers) {
                ...
                for (let i = 0; i < object.headers.length; ++i) {
                    if (typeof object.headers[i] !== 'object')
                        throw TypeError(
                            '.pbbp2.Frame.headers: object expected'
                        );
                    message.headers[i] = $root.pbbp2.Header.fromObject(
                        object.headers[i]
                    );
                }
            }
