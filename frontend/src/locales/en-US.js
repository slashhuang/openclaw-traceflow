...
export default {
  ...
  'setup.nav.access': 'Access',
  'setup.nav.confirm': 'Confirm',
  'setup.paths.title': 'Step 1: State & workspace (local disk)',
  'setup.paths.desc':
    'TraceFlow reads sessions and workspace from disk; aligns with OPENCLAW_STATE_DIR and agents.defaults.workspace. You may use ~ for home.',
  'setup.paths.configPath': 'openclaw.json path (optional)',
  'setup.step1.title': 'Step 2: Connect Gateway (optional)',
  'setup.step1.desc': 'For health and merged Gateway info; skip to use disk-only mode.',
  'setup.skipGateway': 'Skip (local only)',
  'setup.step2.title': 'Step 3: Access control',
  'setup.step2.desc': 'Local-only for personal use; Token for public deploy.',
  'setup.step3.title': 'Step 4: Confirm',
