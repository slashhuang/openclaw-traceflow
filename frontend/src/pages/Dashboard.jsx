...
export default function Dashboard() {
  ...
  const fetchData = async () => {
    try {
      const [healthData, statusData, sessionsData, logsData, latencyData, toolsData, tokenSummaryData, archiveCountMapData] =
        await Promise.all([
          ...
          metricsApi.getTools().catch(() => ({ tools: [], skills: [] })),
      ...
      const acMap = archiveCountMapData && typeof archiveCountMapData === 'object' ? archiveCountMapData : {};
      ...
      const toolStats =
        ...
        Array.isArray(toolsData.tools)
          ? {
              ...
              skills: Array.isArray(toolsData.skills) ? toolsData.skills : [],
            }
          : {
